...
begin
  case Key of
    ...
    VK_OEM_1: Result := XK_semicolon;    //US kbd: ;: key, FR kbd: ;. key
    VK_OEM_PLUS: Result := XK_plus;      //US kbd: =+ key, FR kbd: =+ key
    VK_OEM_COMMA: Result := XK_comma;    //US kbd: ,< key, FR kbd: ,? key
    VK_OEM_MINUS: Result := XK_minus;    //US kbd: -_ key, FR kbd: -6 key
    VK_OEM_PERIOD: Result := XK_period;  //US kbd: .> key, FR kbd: ;. key
    VK_OEM_2: Result := XK_slash;        //US kbd: /? key, FR kbd: :/ key
    VK_OEM_3: Result := XK_asciitilde;   //US kbd: `~ key, FR kbd: ²~ key
    VK_OEM_4: Result := XK_bracketleft;  //US kbd: [{ key, FR kbd: (5 key
    VK_OEM_5: Result := XK_backslash;    //US kbd: \| key, FR kbd: _8 key
